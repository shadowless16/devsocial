  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="lg:hidden bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800 px-3 py-2 flex items-center justify-between sticky top-0 z-40 shadow-sm backdrop-blur-sm bg-white/95 dark:bg-gray-950/95">
        ...
        <h1 className="font-bold text-base sm:text-lg text-navy-900 dark:text-white truncate mx-2">DevSocial</h1>
        ...
        <div className={cn(
          ...
          <div className="absolute top-4 -right-3 z-40">
            <Button 
              ...
              className="w-6 h-6 p-0 rounded-full bg-white dark:bg-gray-950 border-2 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 shadow-md hover:scale-110 active:scale-95"
            >
