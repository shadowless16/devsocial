...
export const swaggerSpec = {
  ...
  paths: {
    ...(authPaths.paths as Record<string, unknown>),
    ...(postsPaths.paths as Record<string, unknown>),
    ...(usersPaths.paths as Record<string, unknown>),
    ...(commentsPaths.paths as Record<string, unknown>),
    ...(likesPaths.paths as Record<string, unknown>),
    ...(gamificationPaths.paths as Record<string, unknown>),
    ...(analyticsPaths.paths as Record<string, unknown>)
  },
  tags: [
